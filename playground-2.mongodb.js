...
collection.updateOne(
	{
		"subcategory": "Fishing",
		"reqs.req_id": "River Jelly"
	},
	{
		$set: {
			"reqs.$.locations": [ "Freshwater" ]
		}
	}
);
collection.updateOne(
...
collection.updateOne(
	{
		"subcategory": "Fishing",
		"reqs.req_id": "Albacore"
	},
	{
		$set: {
			"reqs.$.locations": [ "Ocean" ],
			"reqs.$.times": [ "6am–11am", "6pm–2am" ],
			"reqs.$.seasons": [ "Fall", "Winter" ],
			"reqs.$.weather": [ "Any" ]
    }
	}
);
...
collection.updateOne(
	{
		"subcategory": "Fishing",
		"reqs.req_id": "Blue Discus"
	},
	{
		$set: {
			"reqs.$.locations": [ "Ginger Island (Pond and River)" ],
			"reqs.$.seasons": [ "All" ],
			"reqs.$.weather": [ "Any" ]
    }
	}
...
collection.updateOne(
	...
	{
		$set: {
			"reqs.$.locations": [ "River (Town and Forest)" ],
			"reqs.$.times": [ "6pm–2am" ],
			"reqs.$.seasons": [ "All" ],
			"reqs.$.weather": [ "Any" ]
    }
...
collection.updateOne(
	{
		"subcategory": "Fishing",
		"reqs.req_id": "Bullhead"
	},
	{
		$set: {
			"reqs.$.locations": [ "Mountain Lake" ],
			"reqs.$.seasons": [ "All" ],
			"reqs.$.weather": [ "Any" ]
    }
	}
...
collection.updateOne(
	...
	{
		$set: {
			"reqs.$.locations": [ "Mountain Lake", "Secret Woods Pond", "The Sewers"  ],
			"reqs.$.seasons": [ "All" ],
			"reqs.$.weather": [ "Any" ]
    }
	}
...
collection.updateOne(
	...
	{
		$set: {
			"reqs.$.locations": [ "River (Town and Forest)", "Secret Woods Pond", "Witch's Swamp"  ],
			"reqs.$.times": [ "6am–12am" ],
			"reqs.$.seasons": [ "Spring", "Fall" ],
			"reqs.$.weather": [ "Rain" ]
    }
...
collection.updateOne(
	...
	{
		$set: {
			"reqs.$.locations": [ "Cindersap Forest River", "Mountain Lake" ],
			"reqs.$.seasons": [ "All" ],
			"reqs.$.weather": [ "Any" ]
    }
	}
...
collection.updateOne(
	...
	{
		$set: {
			"reqs.$.locations": [ "Cindersap Forest River" ],
			"reqs.$.times": [ "6am–7pm" ],
			"reqs.$.seasons": [ "Summer" ],
			"reqs.$.weather": [ "Any" ]
    }
...
collection.updateOne(
	{
		"subcategory": "Fishing",
		"reqs.req_id": "Flounder"
	},
	{
		$set: {
			"reqs.$.locations": [ "Ocean", "Ginger Island (Ocean)" ],
			"reqs.$.times": [ "6am–8pm" ],
			"reqs.$.seasons": [ "Spring", "Summer" ],
			"reqs.$.weather": [ "Any" ]
    }
	}
);
collection.updateOne(
	{
		"subcategory": "Fishing",
		"reqs.req_id": "Ghostfish"
	},
	{
		$set: {
			"reqs.$.locations": [ "The Mines (Floor 20 & Floor 60)" ],
			"reqs.$.seasons": [ "All" ],
			"reqs.$.weather": [ "Any" ]
    }
	}
...
collection.updateOne(
	...
	{
		$set: {
			"reqs.$.locations": [ "Cindersap Forest Waterfalls" ],
			"reqs.$.seasons": [ "All" ],
			"reqs.$.weather": [ "Any" ]
    }
	}
...
collection.updateOne(
	...
	},
	{
		$set: {
			"reqs.$.locations": [ "Ocean" ],
			"reqs.$.times": [ "6am–11am", "7pm–2am" ],
			"reqs.$.seasons": [ "Spring", "Summer", "Winter" ],
			"reqs.$.weather": [ "Any" ]
    }
	}
);
...
collection.updateOne(
	...
	{
		$set: {
			"reqs.$.locations": [ "The Mines (Floor 60)" ],
			"reqs.$.seasons": [ "All" ],
			"reqs.$.weather": [ "Any" ]
    }
	}
...
collection.updateOne(
	{
		"subcategory": "Fishing",
		"reqs.req_id": "Lava Eel"
	},
	{
		$set: {
			"reqs.$.locations": [ "The Mines (Floor 100)", "Volcano Dungeon (Floor 10)" ],
			"reqs.$.seasons": [ "All" ],
			"reqs.$.weather": [ "Any" ]
    }
	}
...
collection.updateOne(
	...
	{
		$set: {
			"reqs.$.locations": [ "River (Town and Forest)", "Mountain Lake" ],
			"reqs.$.seasons": [ "Winter" ],
			"reqs.$.weather": [ "Any" ]
    }
	}
...
collection.updateOne(
	{
		"subcategory": "Fishing",
		"reqs.req_id": "Lionfish"
	},
	{
		$set: {
			"reqs.$.locations": [ "Ginger Island (Ocean)" ],
			"reqs.$.seasons": [ "All" ],
			"reqs.$.weather": [ "Any" ]
    }
	}
...
collection.updateOne(
	{
		"subcategory": "Fishing",
		"reqs.req_id": "Midnight Carp"
	},
	{
		$set: {
			"reqs.$.locations": [ "Mountain Lake", "Cindersap Forest Pond", "Ginger Island (Pond and River)"  ],
			"reqs.$.times": [ "10pm–2am" ],
			"reqs.$.seasons": [ "Fall", "Winter" ],
			"reqs.$.weather": [ "Any" ]
    }
...
collection.updateOne(
	{
		"subcategory": "Fishing",
		"reqs.req_id": "Red Snapper"
	},
	{
		$set: {
			"reqs.$.locations": [ "Ocean" ],
			"reqs.$.times": [ "6am–7pm" ],
			"reqs.$.seasons": [ "Summer", "Fall" ],
			"reqs.$.weather": [ "Rain" ]
    }
	}
);
collection.updateOne(
	...
	{
		$set: {
			"reqs.$.locations": [ "River (Town and Forest)", "Cindersap Forest Waterfalls" ],
			"reqs.$.times": [ "6am–7pm" ],
			"reqs.$.seasons": [ "Fall" ],
			"reqs.$.weather": [ "Any" ]
    }
...
collection.updateOne(
	{
		"subcategory": "Fishing",
		"reqs.req_id": "Sandfish"
	},
	{
		$set: {
			"reqs.$.locations": [ "The Desert" ],
			"reqs.$.times": [ "6am–8pm" ],
			"reqs.$.seasons": [ "All" ],
			"reqs.$.weather": [ "Any" ]
    }
...
collection.updateOne(
	...
	},
	{
		$set: {
			"reqs.$.locations": [ "Ocean" ],
			"reqs.$.times": [ "6am–7pm" ],
			"reqs.$.seasons": [ "Spring", "Fall", "Winter" ],
			"reqs.$.weather": [ "Any" ]
    }
	}
);
collection.updateOne(
	{
		"subcategory": "Fishing",
		"reqs.req_id": "Scorpion Carp"
	},
	{
		$set: {
			"reqs.$.locations": [ "The Desert (Fishing Level 4+)" ],
			"reqs.$.times": [ "6am–8pm" ],
			"reqs.$.seasons": [ "All" ],
			"reqs.$.weather": [ "Any" ]
    }
...
collection.updateOne(
	...
	},
	{
		$set: {
			"reqs.$.locations": [ "River (Town and Forest)" ],
			"reqs.$.times": [ "9am–2am" ],
			"reqs.$.seasons": [ "Spring", "Summer", "Fall" ],
			"reqs.$.weather": [ "Rain" ]
    }
	}
);
collection.updateOne(
	{
		"subcategory": "Fishing",
		"reqs.req_id": "Slimejack"
	},
	{
		$set: {
			"reqs.$.locations": [ "Mutant Bug Lair" ],
			"reqs.$.seasons": [ "All" ],
			"reqs.$.weather": [ "Any" ]
    }
	}
...
collection.updateOne(
	{
		"subcategory": "Fishing",
		"reqs.req_id": "Smallmouth Bass"
	},
	{
		$set: {
			"reqs.$.locations": [ "River (Town)", "Cindersap Forest Pond" ],
			"reqs.$.seasons": [ "Spring", "Fall" ],
			"reqs.$.weather": [ "Any" ]
    }
	}
...
collection.updateOne(
	{
		"subcategory": "Fishing",
		"reqs.req_id": "Stingray"
	},
	{
		$set: {
			"reqs.$.locations": [ "Ginger Island Pirate Cove" ],
			"reqs.$.seasons": [ "All" ],
			"reqs.$.weather": [ "Any" ]
		}
	}
...
collection.updateOne(
	{
		"subcategory": "Fishing",
		"reqs.req_id": "Stonefish"
	},
	{
		$set: {
			"reqs.$.locations": [ "The Mines (Floor 20)" ],
			"reqs.$.seasons": [ "All" ],
			"reqs.$.weather": [ "Any" ]
		}
	}
...
collection.updateOne(
	...
	{
		$set: {
			"reqs.$.locations": [ "Ocean", "Ginger Island (River)" ],
			"reqs.$.times": [ "6am–2pm" ],
			"reqs.$.seasons": [ "Summer", "Fall" ],
			"reqs.$.weather": [ "Any" ]
		}
...
collection.updateOne(
	{
		"subcategory": "Fishing",
		"reqs.req_id": "Void Salmon"
	},
	{
		$set: {
			"reqs.$.locations": [ "Witch's Swamp" ],
			"reqs.$.seasons": [ "All" ],
			"reqs.$.weather": [ "Any" ]
		}
	}
...
collection.updateOne(
	{
		"subcategory": "Fishing",
		"reqs.req_id": "Woodskip"
	},
	{
		$set: {
			"reqs.$.locations": [ "Secret Woods Pond" ],
			"reqs.$.seasons": [ "All" ],
			"reqs.$.weather": [ "Any" ]
		}
	}
...
collection.updateOne(
	...
	{
		$set: {
			"reqs.$.locations": [ "Wooden Plank Bridge North of JojaMart/Movie Theater (Fishing Level 3+)" ],
			"reqs.$.seasons": [ "Fall" ],
			"reqs.$.weather": [ "Any" ]
		}
	}
...
collection.updateOne(
	{
		"subcategory": "Fishing",
		"reqs.req_id": "Crimsonfish"
	},
	{
		$set: {
			"reqs.$.locations": [ "East Pier at the Beach (Fishing Level 5+)" ],
			"reqs.$.seasons": [ "Summer" ],
			"reqs.$.weather": [ "Any" ]
		}
	}
...
collection.updateOne(
	{
		"subcategory": "Fishing",
		"reqs.req_id": "Glacierfish"
	},
	{
		$set: {
			"reqs.$.locations": [ "South end of Arrowhead Island in Cindersap Forest (Fishing Level 6+)" ],
			"reqs.$.seasons": [ "Winter" ],
			"reqs.$.weather": [ "Any" ]
		}
	}
...
collection.updateOne(
	...
	{
		$set: {
			"reqs.$.locations": [ "Mountain Lake near the log (Fishing Level 10+)" ],
			"reqs.$.seasons": [ "Spring" ],
			"reqs.$.weather": [ "Rain" ]
		}
	}
...
collection.updateOne(
	{
		"subcategory": "Fishing",
		"reqs.req_id": "Mutant Carp"
	},
	{
		$set: {
			"reqs.$.locations": [ "The Sewers" ],
			"reqs.$.seasons": [ "All" ],
			"reqs.$.weather": [ "Any" ]
		}
	}
...
collection.updateOne(
	{
		"subcategory": "Fishing",
		"reqs.req_id": "Blobfish"
	},
	{
		$set: {
			"reqs.$.locations": [ "Night Market" ]
		}
	}
);
collection.updateOne(
