/**
 * MODULE:  pages/Tracker/Museum.tsx
 * 
 * SUMMARY:
 *   Displays museum requirements with user's progress and allows user to update it.
 * 
 * API USAGE:
 *   - GET /api/getTrackerReqs/Museum - for retrieving requirements
 *   - GET /api/getCheckboxData/Museum - for retrieving initial user progress
 * 
 * DEPENDENCIES:
