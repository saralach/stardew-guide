/**
 * MODULE:  pages/Tracker/Bundles.tsx
 * 
 * SUMMARY:
 *   Displays bundle requirements with user's progress and allows user to update it.
 * 
 * API USAGE:
 *   - GET /api/getTrackerReqs/Bundles - for retrieving requirements
 *   - GET /api/getCheckboxData/Bundles - for retrieving initial user progress
 * 
 * DEPENDENCIES:
